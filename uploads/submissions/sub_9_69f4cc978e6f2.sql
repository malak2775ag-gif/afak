...
INSERT INTO `courses` (`id`, `title`, `slug`, `description`, `short_description`, `thumbnail_url`, `category_id`, `instructor_id`, `status`, `is_free`, `price`, `duration_hours`, `level`, `approved_by`, `approved_at`, `rejection_reason`, `created_at`, `updated_at`, `cover_url`) VALUES
(1, 'static', 'static', 'sfm;v', 'mathlkd', 'uploads/covers/cover_69dfe0a5e7bf29.15709928.jpg', NULL, 2, 'published', 1, '0.00', 241, 'intermediate', 4, '2026-03-05 23:25:05', NULL, '2026-02-25 23:39:33', '2026-04-15 19:22:17', NULL),
(4, 'Introduction to System Administration and OS Installation', 'introduction-to-system-administration-and-os-installation', 'System administrators are crucial to the smooth operation of any organization’s technology stack. They ensure that IT resources are reliable, secure, and optimized for productivity. A proactive sysadmin helps prevent downtime, maintain data integrity, and supports business continuity.', 'System administrators (sysadmins) manage both the hardware and software of an organization\'s IT infrastructure. Core duties include', 'uploads/covers/cover_69e50392769c23.56527578.webp', NULL, 2, 'published', 0, '5.00', 0, 'advanced', 4, '2026-04-19 16:44:07', NULL, '2026-04-19 16:32:18', '2026-04-27 16:17:10', NULL),
(5, 'Introduction to Management Accounting', 'introduction-to-management-accounting', 'Management accounting focuses on supporting internal decision-making rather than external reporting. Its primary purpose is to provide managers with relevant, timely, and accurate information to plan, control, and evaluate business operations effectively. Unlike financial accounting, which is primarily historical and aimed at external stakeholders, management accounting emphasizes future-oriented insights to guide strategic and operational decisions.', 'Management accounting is the process of providing financial and non-financial information to help managers make informed business decisions and improve organizational performance.', 'uploads/covers/cover_69e5056b857cc1.00404936.jpg', NULL, 2, 'published', 1, '0.00', 0, 'all', 4, '2026-04-19 16:44:05', NULL, '2026-04-19 16:40:11', '2026-04-19 16:44:21', NULL),
(6, 'c++', 'c', 'C programming language by providing object-oriented features such as classes, inheritance, and polymorphism, making it suitable for both procedural and object-oriented programming.', 'ssjskk', 'uploads/covers/cover_69e5eb48040209.99466975.webp', NULL, 2, 'published', 1, '0.00', 2, 'intermediate', 4, '2026-04-20 19:37:16', NULL, '2026-04-20 09:00:56', '2026-04-20 19:37:17', NULL);
...
CREATE TABLE IF NOT EXISTS `course_materials` (
  ...
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('video','pdf','document','slide','link') COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `course_materials` (`id`, `unit_id`, `title`, `type`, `content_url`, `file_path`, `duration_seconds`, `sort_order`, `created_at`, `updated_at`) VALUES
(3, 2, 'ghf', 'pdf', 'uploads/materials/mat_69e3a778395c16.63148831.pdf', NULL, NULL, 1, '2026-04-18 15:47:04', '2026-04-18 15:47:04'),
(4, 2, 'slice', 'slide', 'uploads/materials/mat_69e3b331f28445.58928043.pptx', NULL, NULL, 2, '2026-04-18 16:37:05', '2026-04-18 16:37:05'),
(5, 2, 'v', 'video', 'uploads/materials/mat_69e3b34be868c4.13370771.mp4', NULL, NULL, 3, '2026-04-18 16:37:31', '2026-04-18 16:37:31'),
(7, 4, 'ch1', 'pdf', 'uploads/materials/mat_69e503d5cdd436.28411754.pdf', NULL, NULL, 1, '2026-04-19 16:33:25', '2026-04-19 16:33:25'),
(8, 4, 'Introduction to System Administration', 'link', 'https://youtu.be/J4Ih0_No7-k?si=cii5JQaKv83PF6yW', NULL, NULL, 2, '2026-04-19 16:34:23', '2026-04-19 16:34:23'),
(9, 5, 'ch2', 'pdf', 'uploads/materials/mat_69e50440ab99e0.11655897.pdf', NULL, NULL, 1, '2026-04-19 16:35:12', '2026-04-19 16:35:12'),
(10, 8, 'intro', 'link', 'https://youtu.be/KCyg8-zM9bA?si=u0FgPGc__C_cc6dJ', NULL, NULL, 1, '2026-04-19 16:40:47', '2026-04-19 16:40:47'),
(11, 8, 'ch1', 'pdf', 'uploads/materials/mat_69e505a58486a0.37822579.pdf', NULL, NULL, 2, '2026-04-19 16:41:09', '2026-04-19 16:41:09'),
(12, 9, 'ch2', 'pdf', 'uploads/materials/mat_69e5060ff1fd31.21048356.pdf', NULL, NULL, 1, '2026-04-19 16:42:55', '2026-04-19 16:42:55'),
(13, 10, 'ch1', 'pdf', 'uploads/materials/mat_69e5ec4f6374d6.65004002.pdf', NULL, NULL, 1, '2026-04-20 09:05:19', '2026-04-20 09:05:19');
...
INSERT INTO `questions` (`id`, `assessment_id`, `question_text`, `type`, `points`, `sort_order`, `created_at`, `updated_at`) VALUES
(1, 2, 'gjvghkj,lbj', 'file_upload', '1.00', 1, '2026-04-18 16:22:35', '2026-04-18 16:22:35'),
(2, 2, 'fgchfgjhgkh', 'file_upload', '1.00', 2, '2026-04-18 16:22:54', '2026-04-18 16:22:54'),
(3, 3, '1. What is C++ primarily known for?', 'multiple_choice', '1.00', 1, '2026-04-20 08:14:53', '2026-04-20 08:14:53'),
(4, 3, 'erfg;lb,', 'multiple_choice', '1.00', 2, '2026-04-20 08:15:18', '2026-04-20 08:15:18'),
(5, 3, 't/f', 'true_false', '1.00', 3, '2026-04-20 08:15:34', '2026-04-20 08:15:34'),
(6, 3, 'ghmbhvmhg', 'true_false', '1.00', 4, '2026-04-20 10:27:48', '2026-04-20 10:27:48'),
(7, 4, '123456hhfcnc', 'multiple_choice', '1.00', 1, '2026-04-20 19:18:30', '2026-04-20 19:18:30'),
(8, 4, 'fghcghmjvjh,hj,v', 'essay', '1.00', 2, '2026-04-20 19:36:11', '2026-04-20 19:36:11');
...
(1, 'mallak', 'mallak123@utas.edu.om', '$2y$10$PvE02eXH8V0UFzOKLvgYluBZiulaPNiEPyfYs1f8rks7ktWHNNcB6', 'mallak', 'Ahmed', 'student', 'uploads/avatars/avatar_1_1776524771.jfif', '', 1, NULL, '2026-04-29 18:05:21', '2026-02-24 15:55:53', '2026-04-29 18:05:21', 0),
(2, 'mallak22', 'mallak1234@utas.edu.om', '$2y$10$sFRVYbBjvpQU8ZUKuJKUfuOKWmn7usZYFPJZe/Y5Y2L1g93hEPAua', 'mallak', 'mallak', 'instructor', NULL, NULL, 1, NULL, '2026-04-29 17:58:49', '2026-02-24 16:04:31', '2026-04-29 17:58:49', 0),
(4, 'admin', 'mallak@utas.edu.om', '$2y$10$mRXUdA5mnUfw83Ttenfpfu.PiujTPfgGL12YpwJns0uV4b8.Yvryq', 'mallak', 'admin', 'admin', NULL, NULL, 1, NULL, '2026-05-01 12:18:22', '2026-02-24 16:18:41', '2026-05-01 12:18:22', 0),
...
(9, 'mallak s', 'malak528dfg@gmail.com', '$2y$10$AJAQguB3g8b6XR5h3AiY4.qNT/zej67mz9ltJky5K3NYFonQA71Sy', 'malak1', 'malak', 'student', NULL, NULL, 1, NULL, '2026-04-29 17:55:57', '2026-04-22 10:43:12', '2026-04-29 17:55:57', 0),
(10, 'student', 'stu123@utas.edu.om', '$2y$10$lJCJmMuGS366bZgPhLmpfuC0VFQGVq1Y3.sz0es9W0.yeRr/7cGTy', 'mallak', 'Ahmed', 'student', NULL, NULL, 1, NULL, NULL, '2026-05-01 14:24:56', '2026-05-01 14:30:03', 1);
